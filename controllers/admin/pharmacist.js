      ...
      async function (req, res) {
        try {
          ...
          if (req.body.hospital_pharmacy_id != null)
            obj["hospital_pharmacy_id"] = +req.body.hospital_pharmacy_id;

          if (req.body.name != null) obj["name"] = req.body.name;

          if (req.body.hospital_pharmacist_id != null)
            obj["hospital_pharmacist_id"] = +req.body.hospital_pharmacist_id;

          if (req.body.hospital_id != null)
            obj["hospital_id"] = +req.body.hospital_id;
